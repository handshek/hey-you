...
export function GreeterScreen({
    ...
    const [state, setState] = useState<GreeterState>("idle");
    ...
    const handleStreamingComplete = () => {
        // After text finishes streaming, return to idle after a pause
    ...
    return (
        ...
        >
            ...
            >
                <span className="text-amber font-display text-2xl italic">
                    HeyYou
                </span>
            </motion.div>
